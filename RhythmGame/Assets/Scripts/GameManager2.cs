...
public class GameManager2 : MonoBehaviour {
    ...
    public Text timer,collisionText;
    ...
    public MusicSlide2 musicSlide;

    public Animator playerAnimator;
    public EnemyChange2 enemy;
    ...
    public GameObject resultsScreen, CCounter;
    ...
    void Update() {
        ...
        collisionText.text = "Collision Counts: " + collisionCounter;
        ...
        //Results screen
        if (timecount >= 83 && !resultsScreen.activeInHierarchy) {
            Time.timeScale = 0f;
        ...
        if (Input.GetKeyDown(KeyCode.F4) || Input.GetKeyDown(KeyCode.Alpha4)) {
            bool toggleKeyC = CCounter.gameObject.activeSelf;
            toggleKeyC = !toggleKeyC;
            CCounter.gameObject.SetActive(toggleKeyC);
        }
        ...
        if (specialCounter < 10 || timecount < 59) {
            special = false;
        }
        ...
        if (health.currentHealth <= 0) {
            ...
            if (health.currentHealth >= 0 && timecount >= 80 && playerAnimator.GetBool("Dead") != true) { //game finished
            ...
            else if (health.currentHealth >= 0 && timecount < 80 && special == false) { //game not finished
    ...
    public void ChangeEnemies1() {
        if (currentScore >= 5000 && timecount < 48) {
            deadY = true;
    ...
    public void ChangeEnemies2() {
        if (currentScore >= 10000 && timecount < 48) {
            deadG = true;
            onetime2 = true;
            deadY = false;
            stop = true;
    ...
    public void ChangeEnemies3() {
        if (currentScore >= 15000 && timecount < 48) {
            deadR = true;
            onetime3 = true;
            deadG = false;
            stop = true;
    ...
    public void ChangeEnemies4() {
        if (currentScore >= 20000 && timecount < 48) {
            deadD = true;
            onetime4 = true;
            deadR = false;
            stop = true;
    ...
    public void ChangeEnemies5() {
        if (currentScore >= 25000 && timecount < 48) {
            deadY = true;
            onetime5 = true;
            deadD = false;
            stop = true;
    ...
    public void ChangeEnemies6() {
        if (currentScore >= 30000 && timecount < 48) {
            deadG = true;
            onetime6 = true;
            deadY = false;
            stop = true;
    ...
    public void ChangeEnemies8() {
        if ((timecount >= 62 && specialCounter >= 10)) {
            deadD = true;
            onetime8 = true;
            deadtoD = false;
            stop = true;
    ...
    public void NoteMissed() {
        ...
        else if ((health.currentHealth >= 0 && special == false) || (health.currentHealth >= 0 && timecount >= 60)) {
